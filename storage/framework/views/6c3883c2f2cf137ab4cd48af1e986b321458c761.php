            ...
            <div class="ad-header-container">
                <div class="ad-header-menu-container">
                    ...
                    <nav class="ad-navlist">
                        <li >
                            <a href="<?php echo e(route('home')); ?>" class="ad-nav-anchor">Home</a>
                        </li>
                        <li >
                            <a href="<?php echo e(route('about')); ?>" class="ad-nav-anchor">About Us</a>
                        </li>
                        <li >
                            <a href="<?php echo e(route('shop')); ?>" class="ad-nav-anchor">Products</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('service')); ?>" class="ad-nav-anchor">Our Process</a>
                ...
                <div class="ad-logo">
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(route('imagecache', ['template' => 'original', 'filename' => $ws->logo_alt()])); ?>" alt="<?php echo e($ws->name); ?>" style="max-height: 80px;">
                    </a>
                </div>
                <div class="ad-header-pages-container">
                    <li class="dropdown">
                        <a href="<?php echo e(route('image.galleries')); ?>" class="ad-nav-anchor">Gallery</a>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo e(route('contact')); ?>" class="ad-nav-anchor">Contact</a>
                    </li>
                    <div class="d-flex gap-3 align-items-center">
                        <div class="ad-header-cart-container">
                            <a href="<?php echo e(route('cart')); ?>" class="text-decoration-none">
                                <div class="ad-cart-img-container">
                                    <i class="fa-light fa-cart-shopping"></i>
                                    <span class="ad-cart-count"><?php echo e(App\Models\Cart::cartCount()); ?></span>
                                </div>
                            </a>
                        </div>
                        <div class="fs-5">
        ...
        >
            ...
            <div class="offcanvas-body">
                <ul class="ad-responsive-navbar-list">
                    ...
                    <li>
                        <a href="<?php echo e(route('image.galleries')); ?>">Gallery</a>
                    </li>
                    <li>
                ...
                <div class="d-flex gap-4 mt-4 text-center ad-responsive-account">
                    <div>
                        <a href="<?php echo e(route('change.profile')); ?>" class="text-decoration-none" style="color: inherit;">
                            <i class="fa-solid fa-user"></i>
                            <p>Account</p>
                        </a>
                    </div>
                    <div class="position-relative">
                        <a href="<?php echo e(route('cart')); ?>" class="text-decoration-none" style="color: inherit;">
                            <i class="fa-light fa-cart-shopping"></i>
                            <span><?php echo e(App\Models\Cart::cartCount()); ?></span>
                            <p>View Cart</p>
                        </a>
                    </div>
...
<?php /**PATH D:\laragon\laragon\www\mncofee\resources\views/website/layouts/mncofee_header.blade.php ENDPATH**/ ?>