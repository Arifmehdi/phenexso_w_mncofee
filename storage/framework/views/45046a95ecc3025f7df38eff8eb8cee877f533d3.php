...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/animate/animate.compat.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/simple-line-icons/css/simple-line-icons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/owl.carousel/assets/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/owl.carousel/assets/owl.theme.default.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/vendor/magnific-popup/magnific-popup.min.css')); ?>">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/theme.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/theme-elements.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/theme-shop.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/skins/skin-medical.css')); ?>">
...
<div class="body">
    <?php echo $__env->make('frontend.layouts.ecommerceheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <div role="main" class="main mt-5">

        <!-- 🛒 Floating Add to Cart Button -->
        <a class="envato-buy-redirect" href="<?php echo e(route('new.checkout')); ?>">
            <i class="fas fa-shopping-cart"></i>
            <span class="extra-cart-info"><span class="cartItemsCount"><?php echo e($count_data); ?></span></span>
        </a>
        ...
        <div class="mobile-bottom-bar">
            <a href="<?php echo e(route('checkout')); ?>" class="checkout-btn">
                Checkout
                <span class="checkout-price">৳<?php echo e($totalCartPrice); ?></span>
                <i class="fas fa-shopping-cart ms-2"></i>
            </a>
            <div class="other-icons">
                <a href="<?php echo e(url('/')); ?>"><i class="fas fa-home"></i></a>
                <a href="<?php echo e(url('/')); ?>"><i class="fas fa-th-large"></i></a>
...
<!-- ================= Scripts ================= -->
<script src="<?php echo e(asset('frontend/assets/vendor/plugins/js/plugins.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/theme.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/views/view.contact.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/demos/demo-medical.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/custom.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/theme.init.js')); ?>"></script>
...
<?php /**PATH D:\laragon\laragon\www\mncofee\resources\views/frontend/layouts/ecommercemaster.blade.php ENDPATH**/ ?>