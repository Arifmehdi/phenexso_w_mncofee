                ...
                <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div class="footer-widget footer-newsletter-widget">
                        ...
                        <div class="ltn__social-media mt-20">
                            <ul>
                                <li><a href="<?php echo e($ws->fb_url); ?>" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="<?php echo e($ws->twitter_url); ?>" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="#" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                <li><a href="<?php echo e($ws->youtube_url); ?>" title="Linkedin"><i class="fab fa-youtube"></i></a></li>
                            </ul>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-12">
                    <p>© <?php echo e(date('Y')); ?> Hubli Bangladesh – All Rights Reserved.</p>
                </div>
...
<?php /**PATH D:\laragon\laragon\www\mncofee\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>