...
@section('meta')
<meta name="description" content="{{ $ws->meta_description ?? 'Learn more about Uttara Coffee House.' }}">
<meta name="keywords" content="{{ $ws->meta_keywords ?? 'About, Coffee, Uttara' }}">
@endsection
...
<style>
    ...
    .about-page-discount {
        background-image: url("{{ asset('mncofee/assets/img/aida-images/about-page-discount-bg.png') }}") !important;
        background-size: cover;
        background-position: center;
    }
</style>
    ...
    <div class="ad-menu-banner position-relative">
        <div class="ad-menu-banner-overlay">
            <div>
                ...
                <a class="selected-page" href="{{ route('about-us') }}"> About</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="ad-about-image-container position-relative">
            ...
            <div class="mt-sm-5 ad-about-side-image-container">
                ...
                <div class="ad-about-rounded-text about-page-rounded-text">
                    <img src="{{ asset('mncofee/assets/img/aida-images/about-page-rounded-text.png') }}" alt="">
                </div>
            </div>
        </div>
        <div class="ad-about-text-container">
            <h5>about us</h5>
            <h4>{{ $ws->name ?? 'Cafeu' }} restoracia online
...
<section data-aos="fade-up">
    <div class="about-page-discount">
        ...
        <div class="about-page-discount-image">
            <img src="{{ asset('mncofee/assets/img/aida-images/about-page-discount-image.png') }}" class="about-page-discount-image-one" alt="">
