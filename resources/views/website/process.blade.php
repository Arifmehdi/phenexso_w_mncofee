...
@section('title', 'Our Process - '. ($ws->name ?? env('APP_NAME')))

@section('meta')
<meta name="description" content="Learn about our process and how we serve you better at {{ $ws->name ?? env('APP_NAME') }}.">
...
<style>
    ...
    .reservation-page-subscribe {
        background-image: url("{{ asset('mncofee/assets/img/aida-images/reservation-page-subscribe-bg.png') }}") !important;
        background-size: cover;
        background-position: center;
    }
</style>
...
<section class="position-relative" data-aos="fade-up">
    ...
    <form class="reservation-page-form" action="{{ route('contact.store') }}" method="POST">
        @csrf
            ...
            <div class="carousel-inner reservation-page-video-container">
                <div class="carousel-item active position-relative">
                    <div class="text-center">
                        <img
                            class="ad-banner-img"
                            src="{{ asset('mncofee/assets/img/aida-images/reservation-page-video-image.png') }}"
                            alt="Private Events"
                        />
                    </div>
